...
def test_validate_invalid_provider(app, db):
...
def test_validate_invalid_reused_provider(app, db, generic_provider,
                                          master_node):
    from marshmallow import ValidationError
    from gluuengine.reqparser import NodeReq
...
def test_validate_reused_name(app, db, master_node):
    from marshmallow import ValidationError
    from gluuengine.reqparser import NodeReq
